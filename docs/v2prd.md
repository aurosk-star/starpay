...
> 2026-07-13 更新：主动查单补偿、退款核心域、资源型 Webhook 幂等、退款/补偿后台与统一验证命令已完成。以下列表保留为最初差距记录。
...
该项已于 2026-07-13 完成，包含三渠道查单、Redis Worker、指数重试、过期渠道关单和人工重试。
...
该项已于 2026-07-13 完成，包含退款模型、开放/后台 API、三渠道退款与查询、部分退款幂等和退款 Webhook。
...
该项已于 2026-07-13 完成，唯一键已升级为 `event_type + resource_type + resource_id`。
