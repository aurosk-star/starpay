...
var (
	...
	GatewayConfigsColumns = []*schema.Column{
		...
		{Name: "order_default_ttl_seconds", Type: field.TypeInt, Default: 900},
		{Name: "order_expire_scan_interval_seconds", Type: field.TypeInt, Default: 30},
		{Name: "order_expire_scan_limit", Type: field.TypeInt, Default: 100},
		{Name: "order_expire_worker_concurrency", Type: field.TypeInt, Default: 2},
		{Name: "open_api_rate_limit_enabled", Type: field.TypeBool, Default: true},
		{Name: "open_api_rate_limit", Type: field.TypeInt, Default: 120},
		{Name: "open_api_rate_limit_window_seconds", Type: field.TypeInt, Default: 60},
