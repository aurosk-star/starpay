...
func (_u *RefreshTokenUpdate) SetReplacedByHash(v string) *RefreshTokenUpdate {
	_u.mutation.SetReplacedByHash(v)
	return _u
}

// SetNillableReplacedByHash sets the "replaced_by_hash" field if the given value is not nil.
func (_u *RefreshTokenUpdate) SetNillableReplacedByHash(v *string) *RefreshTokenUpdate {
	if v != nil {
		_u.SetReplacedByHash(*v)
	}
	return _u
}

// ClearReplacedByHash clears the value of the "replaced_by_hash" field.
func (_u *RefreshTokenUpdate) ClearReplacedByHash() *RefreshTokenUpdate {
	_u.mutation.ClearReplacedByHash()
	return _u
}
...
func (_u *RefreshTokenUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ReplacedByHash(); ok {
		_spec.SetField(refreshtoken.FieldReplacedByHash, field.TypeString, value)
	}
	if _u.mutation.ReplacedByHashCleared() {
		_spec.ClearField(refreshtoken.FieldReplacedByHash, field.TypeString)
	}
...
// SetReplacedByHash sets the "replaced_by_hash" field.
func (_u *RefreshTokenUpdateOne) SetReplacedByHash(v string) *RefreshTokenUpdateOne {
	_u.mutation.SetReplacedByHash(v)
	return _u
}

// SetNillableReplacedByHash sets the "replaced_by_hash" field if the given value is not nil.
func (_u *RefreshTokenUpdateOne) SetNillableReplacedByHash(v *string) *RefreshTokenUpdateOne {
	if v != nil {
		_u.SetReplacedByHash(*v)
	}
	return _u
...
// ClearReplacedByHash clears the value of the "replaced_by_hash" field.
func (_u *RefreshTokenUpdateOne) ClearReplacedByHash() *RefreshTokenUpdateOne {
	_u.mutation.ClearReplacedByHash()
	return _u
}
