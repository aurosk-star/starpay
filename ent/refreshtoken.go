...
type RefreshToken struct {
	...
	// ReplacedByHash holds the value of the "replaced_by_hash" field.
...
func (*RefreshToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case refreshtoken.FieldTokenHash, refreshtoken.FieldReplacedByHash, refreshtoken.FieldUserAgent, refreshtoken.FieldIPAddress:
...
func (_m *RefreshToken) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case refreshtoken.FieldReplacedByHash:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field replaced_by_hash", values[i])
			} else if value.Valid {
				_m.ReplacedByHash = new(string)
				*_m.ReplacedByHash = value.String
			}
...
func (_m *RefreshToken) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ReplacedByHash; v != nil {
		builder.WriteString("replaced_by_hash=")
