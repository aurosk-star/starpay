...
func (_c *RefreshTokenCreate) SetReplacedByHash(v string) *RefreshTokenCreate {
	_c.mutation.SetReplacedByHash(v)
	return _c
}

// SetNillableReplacedByHash sets the "replaced_by_hash" field if the given value is not nil.
func (_c *RefreshTokenCreate) SetNillableReplacedByHash(v *string) *RefreshTokenCreate {
	if v != nil {
		_c.SetReplacedByHash(*v)
	}
	return _c
}
