...
// ReplacedByHash applies equality check predicate on the "replaced_by_hash" field. It's identical to ReplacedByHashEQ.
func ReplacedByHash(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldEQ(FieldReplacedByHash, v))
}
...
// ReplacedByHashEQ applies the EQ predicate on the "replaced_by_hash" field.
func ReplacedByHashEQ(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldEQ(FieldReplacedByHash, v))
}

// ReplacedByHashNEQ applies the NEQ predicate on the "replaced_by_hash" field.
func ReplacedByHashNEQ(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldNEQ(FieldReplacedByHash, v))
}

// ReplacedByHashIn applies the In predicate on the "replaced_by_hash" field.
func ReplacedByHashIn(vs ...string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldIn(FieldReplacedByHash, vs...))
}

// ReplacedByHashNotIn applies the NotIn predicate on the "replaced_by_hash" field.
func ReplacedByHashNotIn(vs ...string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldNotIn(FieldReplacedByHash, vs...))
}

// ReplacedByHashGT applies the GT predicate on the "replaced_by_hash" field.
func ReplacedByHashGT(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldGT(FieldReplacedByHash, v))
}

// ReplacedByHashGTE applies the GTE predicate on the "replaced_by_hash" field.
func ReplacedByHashGTE(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldGTE(FieldReplacedByHash, v))
}

// ReplacedByHashLT applies the LT predicate on the "replaced_by_hash" field.
func ReplacedByHashLT(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldLT(FieldReplacedByHash, v))
}

// ReplacedByHashLTE applies the LTE predicate on the "replaced_by_hash" field.
func ReplacedByHashLTE(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldLTE(FieldReplacedByHash, v))
}

// ReplacedByHashContains applies the Contains predicate on the "replaced_by_hash" field.
func ReplacedByHashContains(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldContains(FieldReplacedByHash, v))
}

// ReplacedByHashHasPrefix applies the HasPrefix predicate on the "replaced_by_hash" field.
func ReplacedByHashHasPrefix(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldHasPrefix(FieldReplacedByHash, v))
}

// ReplacedByHashHasSuffix applies the HasSuffix predicate on the "replaced_by_hash" field.
func ReplacedByHashHasSuffix(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldHasSuffix(FieldReplacedByHash, v))
}

// ReplacedByHashIsNil applies the IsNil predicate on the "replaced_by_hash" field.
func ReplacedByHashIsNil() predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldIsNull(FieldReplacedByHash))
}

// ReplacedByHashNotNil applies the NotNil predicate on the "replaced_by_hash" field.
func ReplacedByHashNotNil() predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldNotNull(FieldReplacedByHash))
}

// ReplacedByHashEqualFold applies the EqualFold predicate on the "replaced_by_hash" field.
func ReplacedByHashEqualFold(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldEqualFold(FieldReplacedByHash, v))
}

// ReplacedByHashContainsFold applies the ContainsFold predicate on the "replaced_by_hash" field.
func ReplacedByHashContainsFold(v string) predicate.RefreshToken {
	return predicate.RefreshToken(sql.FieldContainsFold(FieldReplacedByHash, v))
}
