...
func (_c *AppCreate) SetAppID(v string) *AppCreate {
...
func (_c *AppCreate) SetAppSecretHash(v string) *AppCreate {
	_c.mutation.SetAppSecretHash(v)
	return _c
}
...
func (_c *AppCreate) SetNillableNotifyURL(v *string) *AppCreate {
	if v != nil {
		_c.SetNotifyURL(*v)
	}
	return _c
...
func (_c *AppCreate) check() error {
	if _, ok := _c.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`ent: missing required field "App.app_id"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "App.name"`)}
	}
	if _, ok := _c.mutation.AppSecretHash(); !ok {
		return &ValidationError{Name: "app_secret_hash", err: errors.New(`ent: missing required field "App.app_secret_hash"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
...
func (_c *AppCreate) createSpec() (*App, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AppSecretHash(); ok {
